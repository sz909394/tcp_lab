...
bool TCPConnection::SENDER_SYN_ACKED()
...
bool TCPConnection::TIME_WAIT()
{return RECEIVER_FIN_RECV() && SENDER_FIN_ACKED();}

bool TCPConnection::LAST_ACK()
{return RECEIVER_FIN_RECV() && SENDER_FIN_SENT() && !_linger_after_streams_finish;}

bool TCPConnection::CLOSE_WAIT()
{return RECEIVER_FIN_RECV() && SENDER_SYN_ACKED();}
